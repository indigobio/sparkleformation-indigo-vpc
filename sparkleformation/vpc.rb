...
EOF
  ...
  dynamic!(:sg_ingress, 'nat-to-private-all', :source_sg => :nat_ec2_security_group, :ip_protocol => '-1', :from_port => '-1', :to_port => '-1', :target_sg => :private_ec2_security_group)
  dynamic!(:sg_ingress, 'private-to-nat-all', :source_sg => :private_ec2_security_group, :ip_protocol => '-1', :from_port => '-1', :to_port => '-1', :target_sg => :nat_ec2_security_group)
